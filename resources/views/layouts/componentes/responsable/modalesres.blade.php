		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<div class="modal-body"> 
					<div id='calendar'></div>
					<form action="{{ url('/responsable') }}" method="GET" role="form" id="formCalendario">
						<!--
						<ul>
	...
	<div class="modal fade" id="modalAsistencias">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
						<!-- Form Asistencias --> 
						<form method="POST" id="formValAsis" action="{{ url('/responsable/validar-asistencia') }}">
								{{  csrf_field()    }}
	...
	<div class="modal fade" id="modalFaltas">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
										<!-- Form Faltas --> 
						<form action="{{ url('/responsable/proyecto') }}" method="POST" id="formGuardarFalta" role="form">
								{{  csrf_field()    }}
								<div class="form-group">
									<label>Fecha:</label>	
	...
	<div class="modal fade" id="modalPermisos">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
										<!-- Form permisos --> 
						<form  action="{{ url('/responsable/proyecto') }}" method="POST" id="formGuardarPermisos" role="form">
								{{  csrf_field()    }}
								<div class="form-group">
									<label>Fecha:</label>	
									<input type="date" class="form-control" id="fecha" min="2015-01-01" max="2025-01-01" name="fecha" required>
...
<!-- Modal para mostrar horario -->
	<div class="modal fade" id="modalHorarioResponsable">
		@csrf
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<!-- Modal Header -->
